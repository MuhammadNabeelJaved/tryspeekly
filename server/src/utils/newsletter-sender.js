...
<div style="margin-top:32px;padding-top:20px;border-top:1px solid #e2e8f0;text-align:center">
  <p style="margin:0;font-size:12px;color:#94a3b8">
    You received this because you subscribed to Speekly newsletters. &nbsp;
...
export const sendNewsletterWelcome = async ({ to, token }) => {
  ...
  const from = process.env.RESEND_FROM_EMAIL || 'Speekly <onboarding@resend.dev>'
  const unsubscribeUrl = `${process.env.CLIENT_URL || 'http://localhost:5173'}/unsubscribe?token=${token}`
  const subject = 'Welcome to Speekly Newsletter! 🎉'
      ...
      <table cellpadding="0" cellspacing="0" style="width:100%;max-width:580px">
        <tr>
          <td style="background:linear-gradient(135deg,#6d28d9,#7c3aed,#4c1d95);border-radius:20px 20px 0 0;padding:32px 40px;text-align:center">
            <p style="margin:0;font-size:24px;font-weight:900;color:#fff">Speekly</p>
        ...
        <tr>
          <td style="background:#fff;padding:40px">
            ...
            <p style="margin:0 0 16px;font-size:15px;color:#475569;line-height:1.7">
              Thank you for subscribing to the <strong>Speekly Newsletter</strong>. You're now part of a community of learners working towards English fluency.
            </p>
            ...
            <p style="margin:0;font-size:14px;color:#94a3b8">— The Speekly Team</p>
          </td>
        </tr>
        <tr>
