        ...
        <table cellpadding="0" cellspacing="0" role="presentation" style="width:100%;max-width:580px">
              ...
              <table cellpadding="0" cellspacing="0" role="presentation" style="margin:0 auto">
                <tr>
                  ...
                  <td style="padding-left:12px;vertical-align:middle">
                    <span style="font-size:22px;font-weight:900;color:#fff;letter-spacing:-0.5px;display:block">Speekly</span>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background:#f8fafc;border-top:1px solid #e2e8f0;border-radius:0 0 20px 20px;padding:24px 40px;text-align:center">
              <p style="margin:0 0 4px;font-size:12px;color:#94a3b8;line-height:1.7">© ${new Date().getFullYear()} Speekly · All rights reserved</p>
...
export const DEFAULT_TEMPLATES = [
  ...
  // ── Auth ──────────────────────────────────────────────────────────────────
  {
    ...
    subject: 'Verify Your Email — Speekly',
    variables: ['name', 'otp'],
    htmlBody: wrap(`
      ${iconCircle('✉️', '#ecfdf5')}
      ${h1('Verify your email address')}
      ${para('Hi <strong>{{name}}</strong>, welcome to Speekly! To get started, please enter the 6-digit verification code below. The code expires in <strong>24 hours</strong>.')}
      ${otpBox('{{otp}}', '#059669')}
      ${divider()}
      ${note('If you didn\'t create an Speekly account, you can safely ignore this email. No action is needed.')}
    `, 'Your Speekly verification code is ready'),
  },

  {
    type: 'otp_forgot_password',
    name: 'Forgot Password OTP',
    subject: 'Reset Your Password — Speekly',
    variables: ['name', 'otp'],
    htmlBody: wrap(`
      ${iconCircle('🔐', '#faf5ff')}
      ${h1('Reset your password')}
      ${para('Hi <strong>{{name}}</strong>, we received a request to reset your Speekly password. Use the code below — it expires in <strong>15 minutes</strong>.')}
      ${otpBox('{{otp}}', '#7c3aed')}
...

  {
    ...
    subject: 'Welcome to Speekly! Your account is verified',
    variables: ['name', 'role', 'dashboardUrl'],
    htmlBody: wrap(`
      ${iconCircle('🎉', '#ecfdf5')}
      ${badge('Account Verified', 'success')}
      ${h1('Welcome to Speekly!')}
    ...
    `, 'Your Speekly account is now active and ready'),
  },
  ...
  // ── Contact ───────────────────────────────────────────────────────────────
  {
    ...
    subject: 'We received your message — Speekly',
    ...
    `, 'Thanks for contacting Speekly — we\'ll be in touch soon'),
  },
  ...
  // ── Enrollments ───────────────────────────────────────────────────────────
  {
    ...
    subject: 'You\'re enrolled in {{courseName}} — Speekly',
  ...
  // ── Payments ──────────────────────────────────────────────────────────────
  {
    ...
    subject: 'Payment proof received for {{courseName}} — Speekly',
...

  {
    ...
    subject: 'Resubmitted payment received for {{courseName}} — Speekly',
    variables: ['studentName', 'courseName', 'amount', 'currency', 'method'],
    htmlBody: wrap(`
      ${iconCircle('🔄', '#fffbeb')}
      ${badge('Under Review', 'warning')}
  ...
  // ── Financial Aid ─────────────────────────────────────────────────────────
  {
    ...
    subject: 'Financial Aid Application Received — Speekly',
...

  {
    ...
    subject: 'Financial Aid Approved! — Speekly',
...

  {
    ...
    subject: 'Financial Aid Application Update — Speekly',
  ...
  // ── Courses ───────────────────────────────────────────────────────────────
  {
    ...
    subject: 'Your course is under review — Speekly',
...

  {
    ...
    subject: 'Your course is approved and live! — Speekly',
    variables: ['teacherName', 'courseName', 'dashboardUrl'],
    htmlBody: wrap(`
      ${iconCircle('🚀', '#ecfdf5')}
      ${badge('Published', 'success')}
      ${h1('Course Approved & Live!')}
      ${para('Hi <strong>{{teacherName}}</strong>, congratulations! Your course has been reviewed, approved, and is now live on Speekly for students to discover and enroll.')}
      ${infoTable(
        infoRow('Course', '{{courseName}}') +
    ...
    `, 'Your course is approved and now live on Speekly'),
  },

  {
    type: 'course_rejected',
    name: 'Course Rejected',
    subject: 'Your course needs revision — Speekly',
  ...
  // ── Live Classes ──────────────────────────────────────────────────────────
  {
    ...
    subject: 'Your live class is now active — Speekly',
  ...
  // ── Assignments ───────────────────────────────────────────────────────────
  {
    ...
    subject: 'New assignment posted for {{courseName}} — Speekly',
  ...
  // ── Salary ────────────────────────────────────────────────────────────────
  {
    ...
    subject: 'Salary Payment Processed — Speekly',
...

  {
    ...
    subject: 'Salary Request Received — Speekly',
  ...
  // ── Reviews ───────────────────────────────────────────────────────────────
  {
    ...
    subject: 'Your review has been submitted — Speekly',
    ...
    htmlBody: wrap(`
      ...
      ${note('Reviews are typically approved within 24 hours. Thank you for helping the Speekly community!')}
...

  {
    ...
    subject: 'Your review is now live — Speekly',
    ...
    htmlBody: wrap(`
      ...
      ${note('Thank you for contributing valuable feedback to the Speekly community. Your review helps other students make informed decisions.')}
    `, 'Your review is now live on Speekly'),
  },
  ...
  // ── Team Member ───────────────────────────────────────────────────────────
  {
    ...
    subject: 'Welcome to the Speekly Team',
    variables: ['name', 'email', 'jobTitle', 'loginUrl'],
    htmlBody: wrap(`
      ${iconCircle('👋', '#eff6ff')}
      ${badge('Team Member Account', 'info')}
      ${h1('Welcome to the Speekly Team!')}
      ${para('Hi <strong>{{name}}</strong>, your team member account has been created for Speekly Academy. We\'re excited to have you on board!')}
      ${infoTable(
    ...
    `, 'Your Speekly team account is ready'),
  },
  ...
  // ── Referral payouts ──────────────────────────────────────────────────────
  {
    ...
    htmlBody: wrap(`
      ...
      ${note('Thank you for spreading the word about Speekly. Keep sharing your referral link to earn more rewards!')}
    `, 'Your referral payout has been approved'),
  },
  {
    type: 'payout_rejected',
    name: 'Payout Rejected (Student)',
    subject: 'Update on your payout request — Speekly',
  ...
  // ── Support ───────────────────────────────────────────────────────────────
  {
    ...
    subject: 'New reply to your support ticket — Speekly',
