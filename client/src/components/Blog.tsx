      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 md:gap-6 mb-12 md:mb-14">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-bold text-gray-900 leading-tight tracking-tight max-w-lg">
              Explore Our Latest News &amp; Blog
            </h2>
          </div>
          <a
            href="#"
            className="hidden lg:inline-flex items-center gap-2 text-violet-600 hover:text-violet-700 font-semibold text-sm transition-colors"
          >
            View All Posts
        ...
        >
          {POSTS.map((post) => (
            <motion.article
              ...
              className="group bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-violet-200 transition-all duration-300 cursor-pointer"
            >
              {/* Image */}
              ...
              <div className="p-6">
                ...
                <motion.h3
                  className="text-[16px] font-bold text-gray-900 leading-snug mb-3 group-hover:text-violet-600 transition-colors duration-300"
                  whileHover={{ scale: 1.02 }}
                  transition={{ duration: 0.2 }}
                >
                  {post.title}
                </motion.h3>
                <p className="text-gray-500 text-sm leading-relaxed mb-5 line-clamp-2 group-hover:text-gray-600 transition-colors duration-300">
                  {post.excerpt}
                </p>

                <motion.a
                  href="#"
                  className="inline-flex items-center gap-1.5 text-violet-600 hover:text-violet-700 font-semibold text-sm transition-all duration-300"
                  whileHover={{ x: 4 }}
        ...
        <div className="flex justify-center mt-10 lg:hidden">
          <a href="#" className="inline-flex items-center gap-2 text-violet-600 font-semibold text-sm">
            View All Posts
            <ArrowRight size={15} weight="bold" />
          </a>
        </div>
