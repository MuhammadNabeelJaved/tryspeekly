...
export default function Courses() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* ─── HERO ─────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-slate-900 dark:bg-slate-950 py-24 lg:py-36">
        {/* Background grid */}
        ...
        <div className="absolute -bottom-40 -right-40 w-[500px] h-[500px] bg-purple-600/15 rounded-full blur-[120px]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[300px] bg-indigo-600/10 rounded-full blur-[100px]" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-violet-500/30 bg-violet-500/10 text-violet-300 text-sm font-semibold mb-8"
            >
              <GraduationCap size={18} weight="fill" />
              World-Class English Programs
            </motion.div>
            ...
            <motion.p
              ...
              className="text-slate-400 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed mb-10"
            >
              From beginner basics to IELTS mastery — expert-led courses designed to get you speaking confidently, faster.
            </motion.p>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-2 bg-violet-600 hover:bg-violet-500 text-white font-bold px-8 py-4 rounded-2xl transition-colors shadow-xl shadow-violet-900/40"
              >
                Browse All Courses <ArrowRight size={20} weight="bold" />
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.04 }}
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-2 border border-white/15 hover:border-white/30 text-white font-semibold px-8 py-4 rounded-2xl transition-colors backdrop-blur-sm"
              >
            ...
            >
              {STATS.map(({ value, label, icon: Icon }, i) => (
                <div
                  key={i}
                  className="bg-slate-900/80 dark:bg-slate-950/80 backdrop-blur-sm px-6 py-6 text-center"
                >
                  <div className="flex justify-center mb-2">
                    <Icon size={22} weight="fill" className="text-violet-400" />
                  </div>
