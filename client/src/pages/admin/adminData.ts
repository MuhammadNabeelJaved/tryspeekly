...
export const INITIAL_PAYMENTS_SETUP: PaymentsPageSetup = {
  ...
  footer: {
    ...
    whatsappLink: 'https://wa.me/923086925545',
  },
}
  ...
  // ── CONTACT ──────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          { key: 'phone', label: 'Phone Number', type: 'text', value: '+92 308 692 5545' },
          { key: 'email', label: 'Email Address', type: 'text', value: 'hello@englishpro.com' },
          { key: 'whatsapp', label: 'WhatsApp Number', type: 'text', value: '+92 308 692 5545' },
          { key: 'whatsappLink', label: 'WhatsApp Link', type: 'url', value: 'https://wa.me/923086925545' },
        ...
        fields: [
          {
            ...
            rows: [
              ...
              { title: 'Contact', content: 'For any privacy-related questions, email us at privacy@englishpro.com or WhatsApp us at +92 308 692 5545.' },
            ],
          } as CMSRepeaterField,
        ],
      },
