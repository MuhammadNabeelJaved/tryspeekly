...
export const INITIAL_PAYMENTS_SETUP: PaymentsPageSetup = {
  ...
  methods: [
    { id: 'pm1', tab: 'local', name: 'Easypaisa', tagline: "Pakistan's #1 Mobile Wallet", description: 'Pay instantly using your Easypaisa mobile account or app. No bank account required.', features: ['Instant transfer', 'Available 24/7', 'No transaction fee', 'Easy app payment'], logoKey: 'easypaisa', logoUrl: '', fallbackBg: '#1BA462', accentColor: '#1BA462', recommended: true, processingTime: 'Instant', buttonText: 'Pay with Easypaisa', accountTitle: 'TrySpeekly', accountIban: '0315-1234567', bankName: 'Easypaisa Mobile Account', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm2', tab: 'local', name: 'JazzCash', tagline: "Pakistan's Trusted Mobile Banking", description: 'Pay seamlessly through your JazzCash wallet, mobile account, or debit card.', features: ['Instant confirmation', 'Mobile number payment', 'Debit card support', 'Secure & encrypted'], logoKey: 'jazzcash', logoUrl: '', fallbackBg: '#CC1F00', accentColor: '#CC1F00', recommended: false, processingTime: 'Instant', buttonText: 'Pay with JazzCash', accountTitle: 'TrySpeekly', accountIban: '0321-9876543', bankName: 'JazzCash Mobile Account', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm3', tab: 'local', name: 'SadaPay', tagline: 'Simple. Modern. Pakistani.', description: 'Transfer directly from your SadaPay IBAN account to ours in seconds.', features: ['IBAN transfer', 'Real-time confirmation', 'Zero fees', 'App & web support'], logoKey: 'sadapay', logoUrl: '', fallbackBg: '#161616', accentColor: '#7C3AED', recommended: false, processingTime: 'Instant', buttonText: 'Pay with SadaPay', accountTitle: 'TrySpeekly', accountIban: 'PK36 SADP 0001 2345 0100 6543', bankName: 'SadaPay', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm4', tab: 'local', name: 'NayaPay', tagline: "Pakistan's Digital Wallet", description: 'Pay via NayaPay e-money account using your registered phone number or IBAN.', features: ['IBAN & phone transfer', 'Instant settlement', 'No hidden charges', 'SBP regulated'], logoKey: 'nayapay', logoUrl: '', fallbackBg: '#5F4FBD', accentColor: '#5F4FBD', recommended: false, processingTime: 'Instant', buttonText: 'Pay with NayaPay', accountTitle: 'TrySpeekly', accountIban: 'PK36 NAYA 0001 2345 0100 6543', bankName: 'NayaPay', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm5', tab: 'local', name: 'NSave', tagline: "Pakistan's Smart Savings App", description: 'Use your NSave balance or linked account to pay your course fee securely.', features: ['Wallet payment', 'Easy transfer', 'Instant receipt', 'Bank-grade security'], logoKey: 'nsave', logoUrl: '', fallbackBg: '#00A896', accentColor: '#00A896', recommended: false, processingTime: 'Instant', buttonText: 'Pay with NSave', accountTitle: 'TrySpeekly', accountIban: 'PK36 NSAV 0001 2345 0100 6543', bankName: 'NSave', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm6', tab: 'local', name: 'Local Bank Transfer', tagline: 'All Pakistani Banks Accepted', description: 'Transfer from any Pakistani bank — HBL, MCB, UBL, Meezan, Allied, etc. — via IBFT.', features: ['All banks supported', 'IBFT / online banking', '1-3 hour clearance', 'Receipt confirmation'], logoKey: 'bank-local', logoUrl: '', fallbackBg: '#334155', accentColor: '#334155', recommended: false, processingTime: '1–3 hours', buttonText: 'Pay via Bank', accountTitle: 'TrySpeekly', accountIban: 'PK36 MEZN 0001 2345 0100 6543', bankName: 'Meezan Bank Ltd.', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm7', tab: 'international', name: 'SadaPay', tagline: 'Receive from Abroad', description: "Send payment from any country using SadaPay's international receiving IBAN.", features: ['International IBAN', 'SWIFT-compatible', 'Real-time alerts', 'Regulated by SBP'], logoKey: 'sadapay', logoUrl: '', fallbackBg: '#161616', accentColor: '#7C3AED', recommended: true, processingTime: '1–2 business days', buttonText: 'Pay via SadaPay', accountTitle: 'TrySpeekly', accountIban: 'PK36 SADP 0001 2345 0100 6543', bankName: 'SadaPay International', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm8', tab: 'international', name: 'NayaPay', tagline: 'Global Transfers Welcome', description: "Receive international remittances through NayaPay's global transfer partnerships.", features: ['Global remittance', 'Partner networks', 'Secure & compliant', 'Easy notification'], logoKey: 'nayapay', logoUrl: '', fallbackBg: '#5F4FBD', accentColor: '#5F4FBD', recommended: false, processingTime: '1–3 business days', buttonText: 'Pay via NayaPay', accountTitle: 'TrySpeekly', accountIban: 'PK36 NAYA 0001 2345 0100 6543', bankName: 'NayaPay International', reference: 'Your Full Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
    { id: 'pm9', tab: 'international', name: 'International Bank Transfer', tagline: 'SWIFT / Wire Transfer', description: 'Send via SWIFT from any bank worldwide. Accepted from UK, US, UAE, Canada, Australia.', features: ['SWIFT / IBAN', 'All currencies', 'All countries', 'Fully secure'], logoKey: 'bank-intl', logoUrl: '', fallbackBg: '#1E40AF', accentColor: '#1E40AF', recommended: false, processingTime: '2–5 business days', buttonText: 'Pay via Bank', accountTitle: 'TrySpeekly', accountIban: 'PK36 MEZN 0001 2345 0100 6543', bankName: 'Meezan Bank Ltd. (SWIFT: MEZNPKKA)', reference: 'Your Full Name + Course Name', whatsappLink: 'https://wa.me/923254320179', receiptEmail: 'payments@tryspeekly.com' },
  ],
  ...
  policiesSection: {
    ...
    noteEmail: 'payments@tryspeekly.com',
  },
  policies: [
  ...
  footer: {
    ...
    whatsappLink: 'https://wa.me/923254320179',
  },
}
...
export const INITIAL_SETTINGS: AdminSettings = {
  ...
  contact: {
    phone: '+92 325 432 0179',
    email: 'hello@tryspeekly.com',
    whatsapp: '+92 325 432 0179',
  ...
  // ── CONTACT ──────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          { key: 'phone', label: 'Phone Number', type: 'text', value: '+92 325 432 0179' },
          { key: 'email', label: 'Email Address', type: 'text', value: 'hello@tryspeekly.com' },
          { key: 'whatsapp', label: 'WhatsApp Number', type: 'text', value: '+92 325 432 0179' },
          { key: 'whatsappLink', label: 'WhatsApp Link', type: 'url', value: 'https://wa.me/923254320179' },
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'whatsapp', label: 'WhatsApp for Receipts', type: 'text', value: '+92 325 432 0179' },
          { key: 'whatsappLink', label: 'WhatsApp Link', type: 'url', value: 'https://wa.me/923254320179' },
          { key: 'email', label: 'Email for Receipts', type: 'text', value: 'payments@tryspeekly.com' },
        ...
        fields: [
          {
            ...
            rows: [
              ...
              { title: 'Your Rights', content: 'You have the right to access, correct, or delete your personal data at any time. To exercise these rights, contact us at privacy@tryspeekly.com.' },
              { title: 'Contact', content: 'For any privacy-related questions, email us at privacy@tryspeekly.com or WhatsApp us at +92 325 432 0179.' },
            ],
          } as CMSRepeaterField,
        ],
      },
        ...
        fields: [
          {
            ...
            rows: [
              ...
              { title: 'Contact', content: 'If you have questions about our Cookie Policy, contact us at privacy@tryspeekly.com.' },
            ],
          } as CMSRepeaterField,
        ],
      },
