    ...
    <div className="p-5 overflow-y-auto flex-1">
      ...
      <div className="flex gap-2 mb-4 flex-wrap">
        ...
        >
          ...
          {['course','blog','blog-comment','review','payment','certificate','financial-aid','support','contact','newsletter-campaign','newsletter-subscriber','seo','coupon','offer','notification','salary-package','salary-payment','salary-request','payout-request','referral-settings','site-settings','geo-access','email-settings','email-template','email-log','email','enrollment'].map(r => (
