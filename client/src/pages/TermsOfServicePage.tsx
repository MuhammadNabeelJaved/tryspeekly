        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-500 dark:text-neutral-400 leading-relaxed font-light">
              These terms govern your use of Speekly. By accessing our platform, you agree to abide by these rules and guidelines.
            </p>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none text-slate-600 dark:text-neutral-300 leading-relaxed">
              ...
              <div id="agreement" className="scroll-mt-32 mb-12">
                ...
                <div className="bg-violet-50 dark:bg-violet-900/10 border-l-4 border-violet-500 p-6 rounded-r-xl mb-6 text-slate-700 dark:text-neutral-200">
                  <p className="m-0 font-medium"><strong>TL;DR:</strong> By using our website, you agree to these rules. If you don't agree, please do not use Speekly.</p>
                </div>
                <p>
                  These Terms of Service constitute a legally binding agreement made between you and Speekly, concerning your access to and use of our website as well as any other media form or application related to it.
                </p>
              </div>
