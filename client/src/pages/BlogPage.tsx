...
export default function BlogPage() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-neutral-950 min-h-screen pt-[72px] lg:pt-[80px] selection:bg-violet-200 dark:selection:bg-violet-900/50">
      <SEOMeta slug="blog" fallbackTitle="Blog — Speekly Academy" fallbackDescription="Study tips, grammar guides, IELTS prep, and course announcements from Speekly Academy." />
